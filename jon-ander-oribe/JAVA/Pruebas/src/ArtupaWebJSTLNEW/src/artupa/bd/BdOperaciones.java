...
public class BdOperaciones extends BdBase {
	...
	public boolean validarUsuarioOLD(String user, String password) {
	...
	public boolean validarUsuario(String user, String password) {
		...
		try {
			...
			List<Object[]> listUsuarios = query.getResultList();
	...
	public List<Cliente> getClientes() {
		...
		try {
			String sentenciaJPAQL = "SELECT c FROM Cliente c";
	...
	public List<Cliente> getClientesOLD() {
	...
	public Cliente getClienteOLD(String dni) {
		Cliente cliente = null;
		try {
	...
	public boolean eliminarClienteOLD(String dni) {
		boolean correcto = true;
		try {
	...
	public boolean insertarClienteOLD(Cliente cliente) {
		boolean correcto = true;
		try {
	...
	public boolean modificarClienteOLD(Cliente cliente) {
		boolean correcto = true;
		try {
