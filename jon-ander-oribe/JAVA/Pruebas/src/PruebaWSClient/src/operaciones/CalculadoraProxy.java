...
public class CalculadoraProxy implements operaciones.Calculadora {
  private String _endpoint = null;
  private operaciones.Calculadora calculadora = null;
  ...
  private void _initCalculadoraProxy() {
    try {
      calculadora = (new operaciones.CalculadoraServiceLocator()).getCalculadora();
      if (calculadora != null) {
        if (_endpoint != null)
  ...
  public operaciones.Calculadora getCalculadora() {
    if (calculadora == null)
      _initCalculadoraProxy();
    return calculadora;
  }
