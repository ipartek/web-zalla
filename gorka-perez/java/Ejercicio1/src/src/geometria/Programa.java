...
public class Programa {
	...
	public static void main(String[] args) {
		...
		// Utiliza el método mayorDistancia para comprobar cuál de los dos
		// puntos (punto1,punto2) está más alejado del eje de coordenadas. 
		...
		System.out.println("El punto más alejado del origen de coordenadas es: ");
