...
function pruebaNivel(){
    ...
    switch(nivel){
        case 1: console.log("nivel 1"); break;
        case 2: console.log("nivel 2"); break;
        case 3: console.log("nivel 3"); break;
        default: console.log("Nivel desconocido"); break;
...
function pruebaEjercicio1(){
    ...
    do{
        var usuario = parseInt(prompt("introduce numero"));
