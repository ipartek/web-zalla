...
public class Programa {
	public static void main(String[] args) {
		...
		Fruta[] combinacion;
		maquina.setCreditoDisponible(credito);
		while (maquina.getCreditoDisponible() > 0) {
			...
			System.out.println("");
			System.out.println(Arrays.toString(combinacion) + " --- " + maquina.getCreditoDisponible());

			// 4.3 Pide al usuario que pulse intro para continuar

			System.out.print("Pulse intro para volver a jugar y C para cobrar  ");
			System.out.print("");
			// comprobamos si metemos por teclado una c para cobrar y acabar el
			// juego
			String s;
			s = teclado.nextLine();
