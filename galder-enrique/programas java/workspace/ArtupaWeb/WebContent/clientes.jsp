	...
	function ejecutarOpcion(opcion) {
		if (opcion == 'alta') {
			...
			if (opcion == 'modificacion') {
				...
				alert('pedidos');
				document.form1.modo_entrada.value = 'modo_pedido';
...
<body>
	...
	<form name=form1 method=post>
		...
		<input type=hidden name=modo_entrada> <input type=button
			...
			onclick="JavaScript:ejecutarOpcion('baja')"> <input
			type=button value=Pedido
			onclick="JavaScript:ejecutarOpcion('pedido')">
	</form>
</body>
</html>